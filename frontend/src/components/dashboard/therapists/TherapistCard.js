...
export default function TherapistCard({ therapist }) {
  ...
  const handleBookSession = async () => {
    ...
    await fetch(`http://127.0.0.1:8000/api/set-session/${uid}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
      bbody: JSON.stringify({
        date: `${sessionDate}T${sessionTime}`,
    ...
    <>
            ...
            <div className="space-y-3">
              ...
              <div className="flex lg:flex-col space-x-2 lg:space-x-0 lg:space-y-2">
                ...
                <button 
                    ...
                    className="flex-1 lg:flex-none border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 px-4 py-2 rounded-lg font-medium transition-colors text-sm">
                  Book Session
                </button>
              </div>
            </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-gray-900 border border-gray-700 text-white p-6 rounded-xl w-80 shadow-2xl">
            ...
            <input
              type="date"
              className="w-full mb-3 p-2 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
              value={sessionDate}
            ...
            <input
              type="time"
              className="w-full mb-4 p-2 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
              value={sessionTime}
            ...
            <div className="flex justify-between">
              ...
              <button
                ...
                className="bg-primary-500 hover:bg-primary-600 px-4 py-2 rounded-lg font-medium transition"
              >
                Confirm
              </button>
            </div>
