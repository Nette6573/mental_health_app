...
export default function SocialLogin({ loading = false }) {
  ...
  // Pull login functions from your AuthContext
  ...
  const socialButtons = [
    {
      ...
      color: 'border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300'
    },
    {
      name: 'Facebook',
      icon: (
      ...
      color: 'border-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 text-blue-600 dark:text-blue-400'
    }
  ]
