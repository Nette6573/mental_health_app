...
export default function ApiSettings({ settings, onSettingChange, onNestedChange }: ApiSettingsProps) {
  ...
  const availablePermissions = [
    ...
    'read:therapists', 'write:therapists', 'delete:therapists',
    'read:sessions', 'write:sessions', 'delete:sessions',
    'read:resources', 'write:resources', 'delete:resources',
    'read:payments', 'write:payments',
    'read:analytics', 'manage:webhooks', 'manage:api_keys',
  ]

  const availableEvents = [
    'user.created', 'user.updated', 'user.deleted',
    'therapist.created', 'therapist.verified',
  ...
  return (
    <div className="space-y-6">
      ...
      {(showApiKeyModal || editingKey) && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4">
            <div className="fixed inset-0 bg-gray-900/50 transition-opacity" onClick={closeApiKeyModal} />
      ...
      {(showWebhookModal || editingWebhook) && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4">
            <div className="fixed inset-0 bg-gray-900/50 transition-opacity" onClick={closeWebhookModal} />
            <div className="relative bg-white dark:bg-gray-800 rounded-lg max-w-lg w-full p-6">
              <h3 className="text-lg font-semibold mb-4">
