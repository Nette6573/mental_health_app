      ...
      {showClearCacheConfirm && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4">
            <div className="fixed inset-0 bg-gray-900/50 transition-opacity" onClick={() => setShowClearCacheConfirm(false)} />
            ...
            <div className="relative bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">Clear System Cache?</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                  This will clear all cached data. The platform may experience slower performance temporarily while the cache rebuilds.
                </p>
