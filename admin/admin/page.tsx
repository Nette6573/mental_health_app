...
export default function AdminLoginPage() {
  ...
  useEffect(() => {
    // Only redirect once the session check has finished (isLoading: false)
    // This prevents the login page from flashing past on initial load
    if (!state.isLoading && state.isAuthenticated) {
      router.push(redirect)
    }
  }, [state.isLoading, state.isAuthenticated, router, redirect])

  // Show nothing while the context is checking localStorage/cookie
  // This prevents a flash of the login form before redirect on valid sessions
  if (state.isLoading) {
    return (
  ...
  // If already authenticated (e.g. navigated back to /admin/login manually), redirect
        ...
        <div className="login-inner">
          ...
          <div className="login-card">
            ...
            <div className="login-form-area">
              ...
              `}</style>
              {state.requiresTwoFactor ? <TwoFactorAuth /> : <AdminLoginForm />}
            </div>
          </div>
