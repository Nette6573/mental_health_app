    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body { background: var(--blue-950); font-family: 'DM Sans', sans-serif; }
        ...
        .field label {
          ...
          color: var(--blue-200); margin-bottom: 8px;
        ...
        .field input::placeholder { color: rgba(147,197,253,0.4); }
        .field input:focus {
        ...
        .forgot {
          ...
          font-size: 0.8rem; color: var(--blue-400);
          text-decoration: none; margin-top: -12px; margin-bottom: 28px;
        ...
        .divider-line { flex: 1; height: 1px; background: rgba(59,130,246,0.15); }
        .divider-text { font-size: 0.75rem; color: var(--blue-400); font-weight: 500; }
        ...
        .stat-label {
          font-size: 0.78rem; color: var(--blue-400); font-weight: 500; margin-top: 4px;
        }
        .stat-divider {
          width: 1px; background: rgba(59,130,246,0.2); align-self: stretch;
        }
        ...
        .footer-copy {
          font-size: 0.82rem; color: var(--blue-400); font-weight: 400;
        }
      ...
      <div className="page-wrap">
        <div className="content">
          ...
          <section className="hero">
            ...
            {/* Login Card */}
            <div className="login-card a3">
              <p className="card-label">Secure Access</p>
              <h2 className="card-title">Admin Sign In</h2>
              <p className="card-sub">Restricted to authorised personnel only</p>

              <div className="field">
                <label htmlFor="email">Email Address</label>
                <input id="email" type="email" placeholder="admin@hopepath.org" />
              </div>
              <div className="field">
              ...
              <Link href="/admin/dashboard">
                <button className="btn-signin">Sign In to Dashboard</button>
              </Link>

              <div className="divider-row">
                <div className="divider-line" />
                <span className="divider-text">Secured with TLS 1.3</span>
                <div className="divider-line" />
              </div>
          ...
          <footer className="footer">
            <div className="footer-inner">
              <span className="footer-copy">© 2025 HopePath by Healing Bridges Inc. Admin use only.</span>
